...
<body>
<h1 align="center" style="color:white;font-size:50px; font-style:italic;">Student Login</h1>
<form class="modal-content animate" action="studentlogin" method="post">
    <div class="imgcontainer">
      <span onclick="document.getElementById('id01').style.display='none'" class="close" title="Close Modal">&times;</span>
      <img src="studlogin.jpg" alt="Avatar" class="avatar">
    </div>

    <div class="container">
      <label for="uname"><b>Login Id</b></label>
      <input type="text" placeholder="Enter loginId" name="studentId" required>
